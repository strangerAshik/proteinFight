...
Route::get('ingredient','frontController@ingredient');  
Route::get('technology','frontController@technology');
Route::get('partnerProject','frontController@partnerProject');

Route::get('about','frontController@about');
Route::get('investroRelations','frontController@investroRelations');
Route::get('career','frontController@career');
Route::get('blog','frontController@blog');
Route::get('singleArticle/{id}','frontController@singleArticle');
Route::get('all-protein-fight-news','frontController@allProteinFightNews');
Route::get('all-international-news','frontController@allInternationalNews');
...
//subscribe save at db
Route::post('saveNewsLetterSubscriber','frontController@saveNewsLetterSubscriber');
});